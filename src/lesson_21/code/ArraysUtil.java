public class ArraysUtil {
    ...
    //метод ищет мин значения по всему массиву и возвр индекс мин знач
    ...
    //метод ищет мин знач от старт индекс до конца массива и возвр инд мин знач
    ...
    // добавляем еще больше гибкости в метод поиска минимума
